...
false disables the compositor and feed polling. Image moderation is next, with
persistence and control semantics awaiting review.
...
Verification: 232 tests pass, including overlay layout/cues, incidents, recovery,
